import torch
from int8_BitLinear import BitLinear
from int8_Bitnet_Transformer import BitnetTransformer
...
for step, batch in enumerate(train_loader):
    ...
    if (step + 1) % accumulation_steps == 0:
        ...
        # 모든 BitLinear 레이어 재양자화
        for module in model.modules():
            if isinstance(module, BitLinear):
                module.requantize_weight()  # BitLinear에 이 메서드 추가 필요
...
# 모델 저장
save_path = "./bitnet_transformer_optimized.pth"
if use_multi_gpu:
